...
const ContactSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://formspree.io/f/xykleykr", {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        toast({
          ...
          description: "Donina se pondrá en contacto contigo pronto.",
        });
      ...
      toast({
        ...
        description: "No se pudo enviar el mensaje. Inténtalo de nuevo o usa WhatsApp.",
      });
    }
  };

  const contactInfo = [
    { icon: MapPin, label: "Dirección", value: import.meta.env.VITE_CONTACT_ADDRESS as string },
    { icon: Phone, label: "Teléfono", value: import.meta.env.VITE_CONTACT_PHONE as string },
    { icon: Mail, label: "Email", value: import.meta.env.VITE_CONTACT_EMAIL as string },
    {
      icon: Clock,
      label: "Horario",
      value: (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a href={`https://wa.me/${import.meta.env.VITE_CONTACT_PHONE}?text=Hola,%20me%20gustaría%20reservar%20una%20cita`} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center hover:bg-primary hover:text-primary-foreground text-primary transition-all duration-300" aria-label="WhatsApp">
