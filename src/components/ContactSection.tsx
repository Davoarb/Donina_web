...
const ContactSection = () => {
  ...
  const contactInfo = [
    { icon: MapPin, label: "Dirección", value: "C. Aguado, 8, 33202 Gijón, Asturias " },
    { icon: Phone, label: "Teléfono", value: "+34 615 12 35 17" },
    { icon: Mail, label: "Email", value: "hipnosisdonina@gmail.com" },
    { 
      icon: Clock, 
      label: "Horario", 
      value: (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="flex gap-4 pt-4">
              ...
              <a href="https://wa.me/34615123517?text=Hola,%20me%20gustaría%20reservar%20una%20cita" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center hover:bg-primary hover:text-primary-foreground text-primary transition-all duration-300" aria-label="WhatsApp">
